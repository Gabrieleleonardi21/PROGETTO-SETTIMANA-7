...
function el(id) {
    ...
    if (!nodo)
        throw new Error(`Elemento #${id} non trovato nel DOM`);
    return nodo;
}
// Ricerca
export const formRicerca = el("search-form");
export const inputRicerca = el("search-input");
// Stato / feedback
...
export const btnIndietro = el("btn-indietro");
...
export const btnModalChiudi = el("modal-chiudi");
